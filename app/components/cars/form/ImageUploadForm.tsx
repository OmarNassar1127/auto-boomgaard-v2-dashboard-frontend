  ...
  return (
    <div className="space-y-6">
      <div className="space-y-4">
        <h3 className="text-lg font-medium">Foto's uploaden</h3>
        ...
        {images.length > 0 && (
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <h4 className="text-md font-medium">{images.length} foto(s) geselecteerd</h4>
              <p className="text-sm text-muted-foreground">
                Sleep om de volgorde te wijzigen, klik op de ster om de hoofdfoto te selecteren
              </p>
            </div>
